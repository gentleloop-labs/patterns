...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get settingsAnalyticsSubtitle =>
      'Compartilhe apenas eventos de uso de recursos. Dados pessoais de TOC nunca são incluídos.';
  ...
  @override
  String get settingsFeedbackSection => 'Comentários';
  ...
  @override
  String get calmInsightsTitle => 'Análises tranquilas';
  ...
  String calmErpActivity(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count práticas de EPR',
      one: '1 prática de EPR',
    );
    return '$_temp0';
  }
  ...
  String get recoveryMetricsCalmTeaserBody =>
      'Veja exposições, sessões de prática e mudanças registradas no impulso em suas ferramentas de EPR. Desbloqueie com o Patterns Pro.';

  @override
  String get recoveryMetricsDetailedTeaserBody =>
      'Veja sequências de prática, exposições concluídas e mudanças registradas no impulso em suas ferramentas de EPR. Desbloqueie com o Patterns Pro.';
  ...
  String get recoveryMetricsCalmEmptyBody =>
      'Pratique um adiamento, uma sessão de EPR ou uma etapa de exposição para ver aqui contagens objetivas de atividade.';

  @override
  String get recoveryMetricsDetailedEmptyBody =>
      'Pratique um adiamento, uma sessão de EPR ou uma etapa de exposição para começar seu histórico e sua sequência de prática.';
  ...
  @override
  String get doneForNowAction => 'Encerrar por agora';
  ...
  @override
  String get completionErpBody => 'Sua prática de EPR foi registrada.';
  ...
  String get dailyReminderBody =>
      'Reserve um momento tranquilo com o Patterns quando quiser.';
  ...
  @override
  String get erpWindowCompleteTitle => 'Tempo de prática de EPR concluído';
  ...
  String get exportReportDescription =>
      'Salve um PDF combinado do seu diário, registro de TOC e análises. Você escolhe onde salvar e se deseja compartilhar.';
  ...
  String exportEntrySummary(int total, int journal, int ocd, int selfChecks) {
    ...
    return '$_temp0 neste período ($journal diário, $ocd TOC, $selfChecks autoavaliações)';
  }
  ...
  @override
  String get pdfNoOcdEvents => 'Nenhum evento de TOC neste período.';
  ...
  String get onboardingHeadline =>
      'Um lugar tranquilo para praticar com o TOC.';
  ...
  String get onboardingPrivacy =>
      'Seus dados de TOC ficam neste dispositivo. Sem conta. Sem sincronização na nuvem.';
  ...
  String get whatsNewBody =>
      'O Patterns 1.10 traz Análises tranquilas, finais de sessão mais discretos, melhorias de acessibilidade e seleção opcional de idioma.';

  @override
  String get whatsNewLanguagesTitle => 'Análises tranquilas';
  ...
  String get whatsNewPrivateBody =>
      'Diário, registro, adiamento de compulsão e sessões de EPR agora terminam com uma confirmação factual e Encerrar por agora.';
  ...
  String get whatsNewNotificationNote =>
      'Seus registros permanecem como foram escritos. Idioma e Análises tranquilas ficam neste dispositivo e não são incluídos em análises nem backups.';
  ...
  String get privacyLocalContent =>
      'Registros do diário, eventos de TOC, níveis de desconforto, reflexões e preferências ficam armazenados localmente neste dispositivo.';
  ...
  String get privacyAnalytics =>
      'A análise anônima de uso fica desativada até você habilitá-la. Se habilitada, o Patterns envia eventos nomeados de uso, um ID aleatório de instalação, plataforma, versão e horário ao serviço próprio. Registros, dados de TOC, resumos gerados, localidade e escolha de idioma nunca são enviados. Desativar apaga eventos pendentes e o ID local.';

  @override
  String get privacyClinicalBoundary =>
      'O Patterns é uma ferramenta de autoajuda para reflexão pessoal e prática de EPR. Não diagnostica nem trata TOC, não substitui o cuidado de um profissional qualificado e não oferece apoio de emergência.';
  ...
  String get proPaywallAlreadyPurchased =>
      'Já comprou o Pro? Essa compra não será cobrada novamente.';
  ...
  @override
  String get desktopFeatureErpTitle => 'Registros de exercícios EPR';
  ...
  @override
  String get desktopFeatureUrgeTitle => 'Surfar o impulso';
  ...
  @override
  String get todayPracticeErpTitle => 'Praticar (EPR)';
  ...
  String get todayFirstErpBody =>
      'Experimente outra prática curta e guiada de EPR.';
  ...
  String get todayNextPracticeBody =>
      'Escolha um exercício de EPR possível para hoje.';
  ...
  @override
  String get todayStartErp => 'Iniciar prática de EPR';
  ...
  @override
  String get todayDailyBody => 'Escreva uma entrada curta quando quiser.';
  ...
  String get trackerContentRequired =>
      'Quando quiser, escreva algumas palavras sobre o que aconteceu.';
  ...
  @override
  String get insightsErpPractice => 'Prática de EPR';
  ...
  String erpFlowText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'saveError':
          'Não foi possível salvar sua prática de EPR. Tente novamente.',
      ...
      'learningHint': 'O que você quer lembrar na próxima vez que o TOC pedir?',
      'exposure': 'Exposição',
      'prediction': 'Previsão',
      'commitment': 'Compromisso',
      'saving': 'Salvando…',
      'save': 'Salvar prática',
      'other': 'Prática de EPR',
    });
    return '$_temp0';
  }
  ...
  String erpPlanText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'myPlans': 'Meus planos de EPR',
      'newAction': 'Novo',
      'plansError': 'Os planos de EPR não estão disponíveis agora.',
      ...
      'saveError': 'Não foi possível salvar seu plano de EPR. Tente novamente.',
      'updated': 'Plano de EPR atualizado.',
      'created': 'Plano de EPR criado.',
      'editTitle': 'Editar plano de EPR',
      'createTitle': 'Criar plano de EPR',
      ...
      'emptyTitle': 'Crie seu primeiro plano de EPR',
      'emptyBody':
  ...
  String erpTemplateTitle(String template) {
    String _temp0 = intl.Intl.selectLogic(template, {
      ...
      'delayReassurance': 'Adiar a busca por reasseguramento',
  ...
  String erpTemplateIntro(String template) {
    String _temp0 = intl.Intl.selectLogic(template, {
      ...
      'other': 'Crie um plano reutilizável de prática de EPR.',
    });
    return '$_temp0';
  }
  ...
  String erpTemplateWhy(String template) {
    String _temp0 = intl.Intl.selectLogic(template, {
      'delayChecking':
          'A EPR permite praticar com a incerteza presente sem fazer um ritual imediatamente.',
      'delayReassurance':
          'O reasseguramento pode parecer útil no momento; adiá-lo permite praticar sem saber com certeza.',
      'delayGoogling':
          'Adiar a pesquisa interrompe o ciclo de certeza e permite praticar deixando uma pergunta sem resposta.',
      'delayRumination':
          'A ruminação pode parecer apenas pensamento; a prática de EPR permite sair do ciclo sem concluir o argumento.',
      'delayWashing':
          'Esperar permite praticar com a sensação de contaminação presente sem fazer um ritual imediatamente.',
      'other': 'A EPR permite dar espaço à incerteza sem um ritual imediato.',
    });
    return '$_temp0';
  }
  ...
  String erpTemplatePrompt(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'delayReassuranceExposure': 'Que confirmação você quer pedir?',
  ...
  String erpTemplateInstruction(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'delayReassurance1':
          'Defina o pedido de reasseguramento antes de começar.',
      'delayReassurance2':
  ...
  String structuredProgramTask(String task) {
    String _temp0 = intl.Intl.selectLogic(task, {
      ...
      'w3b': 'Resista uma vez à vontade de buscar reasseguramento',
  ...
  String ocdTrackWeek(String week) {
    String _temp0 = intl.Intl.selectLogic(week, {
      ...
      'rl2': 'Semana 2 · Sem buscar reasseguramento',
  ...
  String ybocsQuestionPrompt(String question) {
    String _temp0 = intl.Intl.selectLogic(question, {
      ...
      'c_distress':
          'Quanta ansiedade ou perturbação eu sentiria se não pudesse realizar a compulsão?',
  ...
  String ybocsQuestionOption(String option) {
    String _temp0 = intl.Intl.selectLogic(option, {
      ...
      'c_distress_0': 'Nada',
      'c_distress_1': 'Um pouco de inquietação',
      'c_distress_2': 'Ansiedade moderada',
      'c_distress_3': 'Muita ansiedade',
  ...
  String ybocsSymptomLabel(String symptom) {
    String _temp0 = intl.Intl.selectLogic(symptom, {
      'agg_harm_self': 'Medo de me machucar',
      ...
      'agg_responsible': 'Medo de ter responsabilidade por algo terrível',
      ...
      'mc_reassure': 'Pedir reasseguramento ou confessar repetidamente',
  ...
  String behavioralExperimentText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'newAction': 'Novo',
      'subtitle':
          'Compare uma previsão do TOC com o que você observa depois de uma ação planejada.',
      'loadError':
      ...
      'emptyBody':
          'Anote a previsão do TOC, escolha uma pequena ação e depois registre o que você observou.',
      'emptyAction': 'Novo experimento',
      'outcomeEditorTitle': 'Registrar o que aconteceu',
      'newEditorTitle': 'Novo experimento',
      'predictedLabel': 'O TOC previu',
      ...
      'predictionInputLabel': 'O que o TOC prevê?',
      'predictionInputHint':
      ...
      'planValidation':
          'Adicione a previsão do TOC e a ação que você planeja realizar.',
  ...
  String uncertaintyExerciseIntro(String exercise) {
    String _temp0 = intl.Intl.selectLogic(exercise, {
      'maybe':
          'Quando o TOC pedir certeza, experimente responder “talvez sim, talvez não” e volte a atenção ao que você estava fazendo.',
      'unanswered':
  ...
  String actionPlanText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'situationLabel': 'Quando o TOC aparecer',
  ...
  String settingsBackupErpPlanCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count planos de EPR',
      one: '1 plano de EPR',
      zero: 'Nenhum plano de EPR',
    );
    return '$_temp0';
  }
  ...
  String settingsBackupSelfCheckCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count autoavaliações Y-BOCS',
      one: '1 autoavaliação Y-BOCS',
      zero: 'Nenhuma autoavaliação Y-BOCS',
    );
    return '$_temp0';
  }
  ...
  String get analyticsPromptBody =>
      'Compartilhe eventos anônimos de uso de recursos para ajudar a melhorar o Patterns. Entradas do diário, conteúdo de TOC, avaliações, notas, resumos gerados, localidade e escolha de idioma nunca são enviados. O compartilhamento permanece desativado até você escolher ativá-lo.';
  ...
  String shellText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'tourFinalBody':
          'Quando quiser, uma breve autoavaliação Y-BOCS pode registrar uma referência inicial. Ela é opcional, não é um diagnóstico nem apoio de emergência.',
      'takeSelfCheck': 'Fazer autoavaliação',
      'skip': 'Pular',
      'next': 'Próximo',
      ...
      'firstSelfCheckBody':
          'Sua autoavaliação foi salva neste dispositivo. O resultado é um retrato do momento, não um diagnóstico.',
