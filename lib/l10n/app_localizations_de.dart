...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get settingsExportDataSubtitle =>
      'Ihre Einträge in einer lokalen ZIP-Sicherung speichern';
  ...
  String behavioralExperimentText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      ...
      'deleteBody':
          'Dadurch wird das Experiment dauerhaft von diesem Gerät entfernt.',
      'cancel': 'Abbrechen',
      'deleteAction': 'Löschen',
      'deleteTooltip': 'Experiment löschen',
      'deleteSuccess': 'Experiment gelöscht.',
      'deleteError':
          'Dieses Experiment konnte nicht gelöscht werden. Bitte versuchen Sie es erneut.',
      'statusPlanned': 'Geplant',
      'statusCompleted': 'Abgeschlossen',
      'outcomeLabel': 'Was passiert ist',
      'learningLabel': 'Meine Notiz',
      ...
      'experimentInputLabel': 'Mit welcher Handlung prüfen Sie die Vorhersage?',
      'experimentInputHint':
          'Zum Beispiel: Nach einer normalen Kontrolle gehen und beobachten, was passiert',
      'saveOutcome': 'Beobachtung speichern',
      'saveExperiment': 'Experiment speichern',
      'outcomeValidation':
  ...
  String uncertaintyTrainingText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'title': 'Ungewissheit üben',
      'subtitle': 'Üben Sie, Nichtwissen Raum zu geben.',
      'loadError':
          'Die Übungszahlen sind derzeit nicht verfügbar. Sie können die Übungen trotzdem öffnen.',
      'whyLabel': 'ÜBER DIESE ÜBUNG',
      'willingnessLabel': 'Wie bereit waren Sie, das Nichtwissen auszuhalten?',
      'noteLabel': 'Notiz (optional)',
      'noteHint': 'Was ist Ihnen aufgefallen?',
      'saveAction': 'Übung festhalten',
      'saveSuccess': 'Übung festgehalten.',
      'saveError':
          'Diese Übung konnte nicht festgehalten werden. Ihre Notiz ist noch vorhanden. Bitte versuchen Sie es erneut.',
      'other': 'Ungewissheitsübung',
    });
    return '$_temp0';
  }
  ...
  String uncertaintyExerciseTitle(String exercise) {
    String _temp0 = intl.Intl.selectLogic(exercise, {
      'maybe': 'Vielleicht, vielleicht auch nicht',
      'unanswered': 'Unbeantwortet lassen',
      'resist': 'Gewissheitssuche pausieren',
      'other': 'Ungewissheitsübung',
    });
    return '$_temp0';
  }
  ...
  String uncertaintyExerciseIntro(String exercise) {
    String _temp0 = intl.Intl.selectLogic(exercise, {
      ...
      'resist':
          'Bemerken Sie den Drang zu kontrollieren, zu suchen oder um Rückversicherung zu bitten, und entscheiden Sie sich für diese Übung, ihm nicht zu folgen.',
      'other': 'Eine Übung, bei der Ungewissheit präsent bleiben darf.',
    });
    return '$_temp0';
  }
  ...
  String uncertaintyExerciseWhy(String exercise) {
    String _temp0 = intl.Intl.selectLogic(exercise, {
      'maybe':
          'Diese Übung dient dazu, eine Frage ungeklärt zu lassen, ohne weitere Rückversicherung hinzuzufügen.',
      'unanswered': 'Diese Übung dient dazu, eine Frage offen zu lassen.',
      'resist':
          'Mit dieser Übung halten Sie bewusstes Üben ohne Gewissheitssuche fest.',
      'other': 'Dies ist eine Selbsthilfeübung, um Ungewissheit Raum zu geben.',
    });
    return '$_temp0';
  }
  ...
  String uncertaintyExercisePrompt(String exercise) {
    String _temp0 = intl.Intl.selectLogic(exercise, {
      'maybe':
          'Wählen Sie eine Sorge und antworten Sie mit „vielleicht, vielleicht auch nicht“. Bemerken Sie, was da ist, ohne es klären zu wollen.',
      'unanswered':
          'Wählen Sie eine Frage, die Sie sonst klären würden, und lassen Sie sie für diese Übung unbeantwortet.',
      'resist':
          'Bemerken Sie einen Drang nach Gewissheit und lassen Sie ihn für diese Übung unbeantwortet.',
      'other':
          'Wählen Sie eine kleine Möglichkeit, Ungewissheit für diese Übung ungeklärt zu lassen.',
    });
    return '$_temp0';
  }
  ...
  String uncertaintyExerciseSummaryWithCount(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Übungen festgehalten.',
      one: '1 Übung festgehalten.',
    );
  ...
  String uncertaintyWillingness(int value) {
    return 'Bereitschaft $value von 10';
  }

  @override
  String actionPlanText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'title': 'Handlungsplaner',
      'newAction': 'Neu',
      'subtitle':
          'Halten Sie eine Situation und die Reaktion fest, die Sie ausprobieren möchten.',
      'loadError':
          'Ihre Handlungspläne sind derzeit nicht verfügbar. Bitte versuchen Sie es erneut.',
      'deleteTitle': 'Diesen Handlungsplan löschen?',
      'deleteBody':
          'Dadurch wird der Plan dauerhaft von diesem Gerät entfernt.',
      'cancel': 'Abbrechen',
      'deleteAction': 'Löschen',
      'deleteTooltip': 'Handlungsplan löschen',
      'deleteSuccess': 'Handlungsplan gelöscht.',
      'deleteError':
          'Dieser Handlungsplan konnte nicht gelöscht werden. Bitte versuchen Sie es erneut.',
      'statePlanned': 'Geplant',
      'stateCompleted': 'Als abgeschlossen markiert',
      'toggleMarkComplete': 'Handlungsplan als abgeschlossen markieren',
      'toggleMarkIncomplete': 'Handlungsplan als nicht abgeschlossen markieren',
      'toggleSuccessComplete': 'Handlungsplan als abgeschlossen markiert.',
      'toggleSuccessIncomplete':
          'Handlungsplan als nicht abgeschlossen markiert.',
      'toggleError':
          'Dieser Handlungsplan konnte nicht aktualisiert werden. Der vorherige Status wird weiterhin angezeigt. Bitte versuchen Sie es erneut.',
      'emptyTitle': 'Einen Handlungsplan erstellen',
      'emptyBody':
          'Notieren Sie eine Situation und die Reaktion, die Sie dann ausprobieren möchten.',
      ...
      'actionHint':
          'Zum Beispiel: 15 Minuten warten, bevor ich entscheide, ob ich suche',
      'dateLabel': 'Datum (optional)',
      'pickDate': 'Datum auswählen',
      'clearDate': 'Datum entfernen',
      'notesLabel': 'Notizen (optional)',
      'notesHint': 'Alles, woran Sie sich erinnern möchten',
      'saveAction': 'Handlungsplan speichern',
      'validation':
          'Fügen Sie sowohl die Situation als auch die Reaktion hinzu, die Sie ausprobieren möchten.',
      'saveSuccess': 'Handlungsplan gespeichert.',
      'saveError':
  ...
  String actionPlanCardSummary(String status, String situation, String action) {
    return '$status. Situation: $situation. Geplante Reaktion: $action.';
  }

  @override
  String actionPlanDateSummary(String date) {
    return 'Geplantes Datum: $date.';
  }

  @override
  String settingsText(String key) {
    String _temp0 = intl.Intl.selectLogic(key, {
      'proActiveMessage': 'Patterns Pro ist auf diesem Gerät aktiv.',
      'welcomeScheduled':
          'Die Willkommensseiten werden beim nächsten Öffnen von Patterns angezeigt.',
      'exportPromptTitle': 'Daten exportieren?',
      'exportPromptBody':
          'Patterns erstellt eine unverschlüsselte ZIP-Sicherung Ihrer lokalen Einträge. Speichern Sie sie an einem privaten Ort.',
      'exportBackupAction': 'ZIP-Sicherung exportieren',
      'exportDialogTitle': 'Patterns-Daten exportieren',
      'exportSucceeded': 'Daten exportiert.',
      'exportFailed':
          'Der Export ist fehlgeschlagen. Ihre Daten sind unverändert. Bitte versuchen Sie es erneut.',
      'importPromptTitle': 'Daten importieren?',
      'importPromptBody':
          'Wählen Sie eine ZIP- oder JSON-Sicherung von Patterns. Vor dem Ersetzen Ihrer aktuellen Einträge können Sie den Inhalt prüfen.',
      'chooseBackupAction': 'Sicherung auswählen',
      'importDialogTitle': 'Patterns-Sicherung auswählen',
      'backupUnreadable':
          'Patterns konnte diese Sicherungsdatei nicht lesen. Wählen Sie eine andere Datei.',
      'backupInvalid':
          'Dies ist keine gültige Patterns-Sicherung. Ihre aktuellen Daten sind unverändert.',
      'importFailed':
          'Der Import ist fehlgeschlagen. Ihre aktuellen Daten sind unverändert. Bitte versuchen Sie es erneut.',
      'importPreviewTitle': 'Aktuelle Daten ersetzen?',
      'importPreviewIntro':
          'Diese Sicherung enthält die folgenden lokalen Einträge. Beim Import werden Ihre aktuellen Einträge ersetzt.',
      'replaceAction': 'Daten ersetzen',
      ...
      'wipeFailed':
          'Patterns konnte das Löschen der lokalen Daten nicht abschließen. Bitte versuchen Sie es erneut.',
      'appLockDisabled': 'App-Sperre deaktiviert.',
      'deviceLockUnavailable':
          'Die Gerätesperre ist nicht verfügbar. Richten Sie einen Gerätecode oder biometrische Daten ein und versuchen Sie es erneut.',
      'appLockReason': 'Patterns entsperren, um die App-Sperre zu aktivieren.',
      'appLockEnabled': 'App-Sperre aktiviert.',
      'appLockTemporaryLockout':
          'Zu viele Versuche. Versuchen Sie es gleich noch einmal.',
      'appLockBiometricLockout':
          'Die biometrische Authentifizierung ist gesperrt. Entsperren Sie zuerst Ihr Gerät mit dem Gerätecode.',
      'appLockEnableFailed':
          'Patterns konnte die App-Sperre nicht ändern. Bitte versuchen Sie es erneut.',
      'reminderOff': 'Tägliche Erinnerung deaktiviert.',
      'notificationsUnavailable':
          'Benachrichtigungen für Patterns sind ausgeschaltet. Aktivieren Sie sie in den Geräteeinstellungen, um Erinnerungen zu erhalten.',
      'reminderOn': 'Tägliche Erinnerung aktiviert.',
      'reminderChangeFailed':
          'Patterns konnte die Erinnerung nicht ändern. Ihre vorherige Einstellung bleibt bestehen.',
      'analyticsChangeFailed':
          'Patterns konnte die anonyme Nutzungsfreigabe nicht ändern. Ihre vorherige Einstellung bleibt bestehen.',
      'privacyPolicyFailed':
          'Patterns konnte die Datenschutzrichtlinie nicht öffnen. Bitte versuchen Sie es erneut.',
      'other': 'Einstellungen',
    });
    return '$_temp0';
  }
  ...
  String settingsBackupDelayCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Aufschubsitzungen',
      one: '1 Aufschubsitzung',
      zero: 'Keine Aufschubsitzungen',
    );
    return '$_temp0';
  }
  ...
  String settingsBackupErpPlanCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count ERP-Pläne',
      one: '1 ERP-Plan',
      zero: 'Keine ERP-Pläne',
    );
    return '$_temp0';
  }
  ...
  String settingsBackupSelfCheckCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Y-BOCS-Selbstchecks',
      one: '1 Y-BOCS-Selbstcheck',
      zero: 'Keine Y-BOCS-Selbstchecks',
    );
    return '$_temp0';
  }
  ...
  String settingsReminderSetFor(String time) {
    return 'Erinnerung auf $time eingestellt.';
  }

  @override
  String get appUnlockReason => 'Patterns entsperren, um fortzufahren.';

  @override
  String get appLockUnavailableDisabled =>
      'Die biometrische Authentifizierung ist nicht verfügbar. Die App-Sperre wurde deaktiviert.';

  @override
  String get appUnlockFailed =>
      'Patterns konnte nicht entsperrt werden. Bitte versuchen Sie es erneut.';

  @override
  String get privacyScreenLabel => 'Patterns-Datenschutzbildschirm';

  @override
  String get unlockingAction => 'Wird entsperrt…';

  @override
  String get unlockAction => 'Entsperren';

  @override
  String get analyticsPromptTitle => 'Patterns verbessern helfen?';
