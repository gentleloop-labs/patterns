...
updated: '2026-09-18'
readingMinutes: 10
excerpt: 'A return of intrusive thoughts or compulsions can feel like starting over. Recovery is better judged by the pattern over time, how you respond, and how much of your life OCD is controlling.'
category: living-with-ocd
contentType: evidence-guide
draft: false
tags: [ocd-basics, erp, compulsions]
keywords: 'OCD flare-up, OCD relapse, OCD recovery, OCD symptoms coming back, setback in OCD recovery, relapse prevention OCD'
faq:
  - q: 'Does one difficult day mean I have relapsed?'
    a: 'Not by itself. A brief increase in intrusive thoughts, distress, or compulsions is different from a sustained return toward your previous level of symptoms and impairment. Look at the broader pattern and discuss a persistent or disruptive change with a qualified clinician.'
  - q: 'What can trigger an OCD flare-up?'
    a: 'People may notice symptoms become louder during stress, illness, disrupted sleep, major life changes, or periods when avoidance and compulsions have grown. A trigger does not always have a clear cause, and identifying one is not required before you resume helpful routines or seek support.'
  - q: 'What should I do when OCD symptoms increase?'
    a: 'Return to the treatment plan you made with your clinician, notice which compulsions or avoidance have returned, and restart a manageable ERP practice if that is already part of your care. Do not change prescribed medication or attempt risky exposures without professional guidance.'
  - q: 'When should I contact an OCD professional?'
    a: 'Contact a qualified professional when symptoms keep worsening, take substantially more time, interfere with daily life, or feel difficult to manage with your existing plan. Seek urgent local help if you may be in immediate danger or unable to stay safe.'
related: [between-therapy-sessions, what-to-expect-first-erp-sessions, when-an-ocd-app-becomes-a-compulsion]
---
...
Starting again does not mean punishing yourself with the hardest item on an exposure hierarchy. [Early ERP is normally collaborative and planned](/blog/what-to-expect-first-erp-sessions). The relevant practice is the one that targets the returning pattern while remaining safe and usable.
...
- [International OCD Foundation: Relapse Prevention in the Treatment of OCD](https://iocdf.org/expert-opinions/expert-opinion-relapse-prevention/)
- [International OCD Foundation: Exposure and Response Prevention](https://iocdf.org/about-ocd/ocd-treatment-guide/erp/)
- [NICE guideline CG31: Obsessive-compulsive disorder and body dysmorphic disorder](https://www.nice.org.uk/guidance/cg31/chapter/Recommendations)
- [NHS: Treatment for obsessive-compulsive disorder](https://www.nhs.uk/mental-health/conditions/obsessive-compulsive-disorder-ocd/treatment/)
- Adams, T. G., Kelmendi, B., Brake, C. A., Gruner, P., & Badour, C. L. (2018). [The role of stress in the pathogenesis and maintenance of obsessive-compulsive disorder](https://pmc.ncbi.nlm.nih.gov/articles/PMC5841259/). *Chronic Stress*, 2.
- Foa, E. B., Simpson, H. B., Gallagher, T., et al. (2022). [Maintenance of wellness in patients with obsessive-compulsive disorder who discontinue medication after exposure/response prevention augmentation](https://pmc.ncbi.nlm.nih.gov/articles/PMC8792795/). *JAMA Psychiatry*, 79(3), 193-200.
- McKay, D. (1997). [A maintenance program for obsessive-compulsive disorder using exposure with response prevention: 2-year follow-up](https://pubmed.ncbi.nlm.nih.gov/9134790/). *Behaviour Research and Therapy*, 35(4), 367-369.
