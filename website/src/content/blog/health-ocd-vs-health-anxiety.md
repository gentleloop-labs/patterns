...
updated: '2026-08-28'
readingMinutes: 10
excerpt: 'Health OCD and health anxiety can look identical from the outside. The useful distinction is the response pattern: a ritual that tries to settle an intrusive doubt, versus a more persistent conviction that you are already ill.'
category: ocd-themes
contentType: evidence-guide
draft: false
tags: [subtypes, compulsions, erp, ocd-basics]
keywords: 'health OCD vs health anxiety, health anxiety vs OCD, illness anxiety disorder OCD, hypochondria vs OCD, health concern OCD, googling symptoms OCD'
faq:
  - q: 'Is health anxiety a form of OCD?'
  ...
  - q: 'What is the main difference between health OCD and health anxiety?'
...
- **Googling.** Matching a sensation to a diagnosis, then matching the diagnosis to a worse one. See [reassurance seeking](/blog/reassurance-seeking-ocd).
...
This presentation overlaps with [contamination OCD](/blog/contamination-ocd) when the fear is catching or transmitting illness, and with [checking OCD](/blog/checking-ocd) when the ritual is verifying the body. It also overlaps with [harm OCD](/blog/harm-ocd-intrusive-thoughts) when the feared outcome is causing illness in someone else. The theme can jump. That hopping is one of the more useful clues that the engine is OCD rather than a single disease fear. A related but different body-focused presentation is [sensorimotor OCD](/blog/sensorimotor-ocd), in which attention sticks to an automatic process such as breathing or swallowing. The feared outcome there is usually the noticing itself, not a disease.
...
- [American Psychiatric Association: What Is Somatic Symptom Disorder?](https://www.psychiatry.org/patients-families/somatic-symptom-disorder/what-is-somatic-symptom-disorder)
