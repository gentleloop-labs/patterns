---
title: 'ERP vs CBT for OCD: Why the Distinction Matters'
description: ERP is a form of CBT, but not all CBT is ERP - and for OCD the difference decides whether therapy helps. Here is how the two relate, in plain language.
date: '2026-08-06'
updated: '2026-08-06'
readingMinutes: 6
...
faq:
  - q: 'Is ERP a type of CBT?'
    a: 'Yes. ERP is a behavioral therapy that sits inside the cognitive behavioral therapy family. When treatment guidelines recommend CBT for OCD, they specifically mean CBT that includes exposure and response prevention.'
  - q: 'Will general CBT help my OCD?'
    a: 'It may help with co-occurring problems such as depression, and cognitive techniques are often used alongside ERP. But CBT delivered without exposure and response prevention has substantially weaker evidence for OCD, and some standard cognitive techniques can be turned into compulsions by OCD.'
  - q: 'What should I ask a therapist before starting?'
    a: 'Ask directly whether they use exposure and response prevention for OCD, how many people with OCD they have treated, and what a first hierarchy would look like. A therapist trained in OCD will answer specifically rather than in general terms about anxiety.'
related: [what-is-erp-exposure-response-prevention, is-patterns-a-cbt-app, ocd-vs-anxiety-difference]
---
...
For OCD, the branch with the strongest evidence is [exposure and response prevention](/blog/what-is-erp-exposure-response-prevention). You approach what triggers the obsession, and you do not perform the compulsion. Over repetition your brain learns something it could never learn while the compulsions were running.
...
- **Reassuring reframes** deliver exactly what the OCD is hunting for. Relief now, a tighter loop later. See [reassurance seeking](/blog/reassurance-seeking-ocd).
...
The same applies to apps and self-help material. "CBT for anxiety" and "CBT with ERP for OCD" are meaningfully different products, and the label alone does not distinguish them. We wrote about how this shapes [what Patterns is and is not](/blog/is-patterns-a-cbt-app).
...
- [International OCD Foundation: Treatment of OCD](https://iocdf.org/about-ocd/treatment/)
