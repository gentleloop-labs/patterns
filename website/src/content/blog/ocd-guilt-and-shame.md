---
title: 'OCD Guilt and Shame: Why a Feeling Is Not Evidence'
description: 'OCD guilt and shame feel like proof, but a feeling is not evidence. Learn why the emotion is so convincing and how treatment addresses it.'
date: '2026-08-22'
updated: '2026-08-22'
readingMinutes: 10
...
faq:
  ...
  - q: 'Why does OCD guilt feel so real?'
...
This pattern shows up across themes. It is central to [real-event OCD](/blog/real-event-ocd), where a genuine past act is used as a hook for an unanswerable question. It is central to [scrupulosity](/blog/scrupulosity-religious-ocd), where the alarm wears the clothes of conscience. It is just as present in harm thoughts, relationship doubts, and mental reviewing that never attaches to a single named event.
...
- **Reassurance seeking.** Asking "would a good person think this?" in different words, or searching until a post matches closely enough. See [reassurance seeking](/blog/reassurance-seeking-ocd).
...
[Exposure and response prevention](/erp) is the first-line psychological treatment for OCD, including presentations where guilt and shame are the loudest symptoms. The target is not "feeling less." The target is changing the response that treats the feeling as a command.
