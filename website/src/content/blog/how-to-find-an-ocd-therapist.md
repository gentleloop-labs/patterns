...
updated: '2026-09-13'
readingMinutes: 9
excerpt: 'A licence tells you someone can practise therapy. A few direct questions can tell you whether they understand OCD and actually use ERP.'
category: treatment-erp
contentType: evidence-guide
draft: false
tags: [erp, ocd-basics]
keywords: 'how to find an OCD therapist, OCD therapist, ERP therapist, questions to ask an OCD therapist, OCD specialist'
faq:
  - q: 'What type of therapist is best for OCD?'
    a: 'The professional title matters less than appropriate licensing, specific training in OCD, and real experience delivering cognitive behavioural therapy with exposure and response prevention. Psychologists, counsellors, social workers, and other qualified clinicians may all provide ERP within the rules of their location.'
  - q: 'How can I tell whether a therapist really uses ERP?'
    a: 'Ask them to explain how they assess compulsions and avoidance, build an exposure hierarchy, practise exposures in and between sessions, and prevent both visible and mental rituals. A provider who uses ERP should be able to answer concretely without promising a particular result.'
  - q: 'Is an IOCDF directory listing proof that a therapist is qualified?'
    a: 'No. The IOCDF states that providers in its directory self-report their experience and that a listing is not an endorsement or assessment of competence. The directory is a useful starting point, but you should still verify credentials, training, costs, and fit.'
  - q: 'What if I cannot find a local OCD specialist?'
    a: 'Ask about teletherapy where licensing rules permit it, supervised trainees, specialist consultation for a local clinician, group treatment, and lower-intensity CBT with ERP services. Availability and legal requirements vary by location.'
related: [what-happens-during-an-ocd-assessment, what-is-erp-exposure-response-prevention, how-to-build-an-exposure-hierarchy]
---
...
The [IOCDF Resource Directory](https://iocdf.org/find-help/) is a useful place to begin. It includes clinicians, clinics, programmes, support groups, and teletherapy options, with filters for location and areas of focus. Its credential filters can also identify clinicians who report completing the IOCDF's Behavior Therapy Training Institute, an intensive ERP training programme.
...
ERP should be collaborative. The IOCDF states that people are not forced or deceived into exposures. A therapist will usually map triggers, feared outcomes, avoidance, and rituals, then build an [exposure hierarchy](/blog/how-to-build-an-exposure-hierarchy) with you. They should be able to explain how an exercise serves a treatment goal and what response prevention it includes.
...
Our guide to [what happens during an OCD assessment](/blog/what-happens-during-an-ocd-assessment) describes the information a clinician may gather before treatment planning.
...
- [International OCD Foundation: Getting Started with the Resource Directory](https://iocdf.org/help/)
- [International OCD Foundation: Exposure and Response Prevention](https://iocdf.org/about-ocd/ocd-treatment-guide/erp/)
- [International OCD Foundation: Behavior Therapy Training Institute](https://iocdf.org/professionals/training-institute/btti/)
