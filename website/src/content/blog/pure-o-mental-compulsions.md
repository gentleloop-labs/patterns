...
faq:
  - q: 'Is Pure O a real diagnosis?'
    a: 'No. It is an informal, widely used description rather than a diagnostic category. There is no separate Pure O entry in the DSM-5 - it is OCD in which the compulsions are mental rather than observable.'
  - q: 'What are mental compulsions?'
    a: 'Repetitive mental acts performed to reduce distress or prevent a feared outcome. Common examples include mentally reviewing events, silently reassuring yourself, praying, counting, mentally arguing with the thought, and checking your own feelings for evidence.'
  - q: 'Is rumination a compulsion?'
    a: 'When it is done to settle a doubt or neutralise distress, yes, clinicians generally treat it as a compulsion. Distinguishing it from the obsession matters, because the obsession is what you expose yourself to and the rumination is what you prevent.'
  - q: 'Can ERP work if my compulsions are all mental?'
    a: 'Yes, and it is the recommended treatment. It is harder to implement because you have to become able to spot the compulsion as it starts, which is a skill that takes practice. Imaginal exposure is used heavily.'
related: [harm-ocd-intrusive-thoughts, reassurance-seeking-ocd, what-is-erp-exposure-response-prevention]
---
...
This distinction is not pedantry. It decides whether treatment works, because [ERP](/blog/what-is-erp-exposure-response-prevention) targets compulsions, and you cannot prevent a response you have not noticed.
...
- **Mental review.** Going back over a conversation, a memory, or an event to establish what happened. Central to [real-event OCD](/blog/real-event-ocd).
...
- **Checking your feelings.** Scanning your body or your emotional reaction for evidence about what you really want. The groinal check in [sexual orientation OCD](/blog/sexual-orientation-ocd), the "do I still feel love" check in [ROCD](/blog/relationship-ocd-rocd).
...
- [International OCD Foundation: Mental compulsions and "Pure O"](https://iocdf.org/about-ocd/)
