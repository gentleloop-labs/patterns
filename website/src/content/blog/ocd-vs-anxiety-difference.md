---
title: 'OCD vs Anxiety: How to Tell the Difference'
description: OCD and anxiety disorders feel similar from the inside but are treated differently. Here is the distinction that matters, and why it changes what helps.
date: '2026-08-06'
updated: '2026-08-06'
readingMinutes: 7
...
faq:
  - q: 'Is OCD an anxiety disorder?'
    a: 'It used to be classified as one. In the DSM-5, published in 2013, OCD was moved out of the anxiety disorders chapter into a new category called obsessive-compulsive and related disorders, reflecting differences in how it presents and responds to treatment. Anxiety is still central to the experience of OCD.'
  - q: 'What is the main difference between OCD and anxiety?'
    a: 'The compulsion. Anxiety disorders involve worry and avoidance. OCD adds a repetitive behavior or mental act performed to neutralise the distress, and that act is what maintains the cycle.'
  - q: 'Can you have both OCD and an anxiety disorder?'
    a: 'Yes, and it is common. Co-occurring anxiety and depressive disorders are frequent alongside OCD. A clinician can treat both, but the OCD component generally still needs exposure and response prevention specifically.'
related: [what-is-erp-exposure-response-prevention, reassurance-seeking-ocd, the-loop-and-how-i-loosen-it]
---
...
The relief is the trap. Each pass teaches your brain that the obsession was a genuine threat and that the compulsion averted it. We wrote about what this feels like day to day in [the loop, and how I loosen it](/blog/the-loop-and-how-i-loosen-it).
...
|---|---|---|
| **Content** | Usually realistic worries, scaled up | Often improbable, taboo, or magical in flavour |
| **Relationship to the thought** | Feels like your own concern | Often feels alien, unwanted, "not me" |
| **What follows** | Avoidance, worry, reassurance | A specific ritual, repeated, often with rules |
| **Feeling of completion** | Fades when circumstances change | Must feel "right" or "complete" before it stops |
| **Doubt** | "This might go badly" | "How can I ever *know* this will not go badly?" |
| **What treatment targets** | The worry and the avoidance | The compulsion |
...
- **"Reassure yourself that it is not going to happen."** This is [reassurance seeking](/blog/reassurance-seeking-ocd), and it feeds the loop.
...
The OCD-specific treatment is [ERP](/blog/what-is-erp-exposure-response-prevention), which does close to the opposite: approach the trigger, leave the question unresolved, and do not perform the ritual.
...
- American Psychiatric Association. (2013). *Diagnostic and Statistical Manual of Mental Disorders* (5th ed.) - OCD reclassified under obsessive-compulsive and related disorders.
