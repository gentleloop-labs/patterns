...
updated: '2026-08-13'
readingMinutes: 9
excerpt: 'An unwanted thought by itself does not tell you whether you have OCD. The more useful question is what happens next: distress, rituals, temporary relief, and the same doubt returning.'
category: recognizing-ocd
contentType: evidence-guide
draft: false
tags: [ocd-basics, intrusive-thoughts, compulsions]
keywords: 'do I have OCD, intrusive thoughts or OCD, signs of OCD, OCD symptoms, OCD compulsions, mental compulsions'
faq:
  - q: 'Does everyone have intrusive thoughts?'
    a: 'Unwanted intrusive thoughts occur outside OCD and can resemble OCD obsessions in content. What differs is usually their frequency, intensity, consequences, and the response pattern that develops around them.'
  - q: 'Can I have OCD if I only have thoughts and no visible rituals?'
    a: 'Yes. Compulsions can be mental acts such as reviewing, checking feelings, silently reassuring yourself, praying, counting, or trying to neutralize a thought. A qualified mental health professional can assess whether these experiences meet the criteria for OCD.'
  - q: 'How do I know whether a behavior is a compulsion?'
    a: 'Look at its function rather than its appearance. A behavior or mental act may be compulsive when it is repeated to reduce distress, prevent a feared outcome, or obtain certainty, and the relief is temporary.'
  - q: 'Who can diagnose OCD?'
    a: 'A qualified health or mental health professional can diagnose OCD after asking about obsessions, compulsions, distress, time, and interference, while also considering other explanations for the symptoms.'
related: [ocd-vs-anxiety-difference, pure-o-mental-compulsions, reassurance-seeking-ocd]
---
...
That means the useful unit is not just the thought. It is the [OCD cycle](/ocd):
...
This is why someone can spend years believing they have obsessions but no compulsions. The rituals may be happening entirely inside their head. The guide to [Pure O and mental compulsions](/blog/pure-o-mental-compulsions) explores that distinction in more detail.
...
The distinction between [OCD and anxiety](/blog/ocd-vs-anxiety-difference) often rests on the compulsion loop. General worry tends to move among plausible concerns and toward preparation. OCD tends to demand an impossible level of certainty and recruit rituals that briefly relieve the distress.
...
OCD is treatable. [Exposure and response prevention](/blog/what-is-erp-exposure-response-prevention), usually called ERP, is a form of cognitive behavioral therapy used specifically for OCD. It involves gradually making contact with triggers while changing the compulsive response that keeps the loop going.
...
- [National Institute of Mental Health: Obsessive-Compulsive Disorder](https://www.nimh.nih.gov/health/publications/obsessive-compulsive-disorder-when-unwanted-thoughts-or-repetitive-behaviors-take-over)
- [International OCD Foundation: How Is OCD Diagnosed?](https://iocdf.org/about-ocd/how-is-ocd-diagnosed/)
- [NICE guideline: Obsessive-compulsive disorder and body dysmorphic disorder](https://www.nice.org.uk/guidance/cg31)
- Rachman, S., & de Silva, P. (1978). Abnormal and normal obsessions. *Behaviour Research and Therapy*, 16(4), 233-248. [DOI](https://doi.org/10.1016/0005-7967(78)90022-0)
