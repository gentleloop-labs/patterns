...
description: Obsession, distress, compulsion, relief - then it starts again. Here is how I learned to see the OCD loop, and the small moves that give me room inside it.
date: '2026-07-11'
updated: '2026-07-11'
readingMinutes: 4
...
<p>
  ...
  <strong>compulsion</strong> - checking, googling, washing,
  <a href="/blog/reassurance-seeking-ocd">seeking reassurance</a>, or just
  ruminating in circles. And I get <strong>relief</strong>, real relief,
...
<p>
  ...
  down. That is the whole secret of <a href="/erp">response prevention</a>, and you
  have to feel it to believe it. The compulsion delay tool in the app is just a
  timer and a place to notice that it happened.
</p>
<blockquote>
