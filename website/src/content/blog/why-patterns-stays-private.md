...
<p>
  ...
  the whole point of <a href="/erp">ERP</a> is to face the exact thoughts you most
  want to hide. If part of me was performing for an invisible audience, or worrying
  where the data went, that part would sabotage the work. Privacy is not a
  nice-to-have on top of the therapy. For this kind of app, it is a precondition
  for the therapy working.
</p>
<blockquote>
...
<p>
  ...
  is a one-time unlock for the <a href="/toolkit">deeper recovery tools</a> - you
  pay once, you own it,
