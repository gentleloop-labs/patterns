...
faq:
  - q: 'Is contamination OCD just being a germaphobe?'
    a: 'No. Contamination OCD is driven by a feeling of contamination that does not track actual risk, and it comes with compulsions that are excessive, rule-bound, and never quite complete. It also frequently involves things that cannot transmit anything at all, such as a person, a word, or a memory.'
  - q: 'What is mental contamination?'
    a: 'A sense of internal dirtiness that arises without physical contact with anything - typically from a memory, a thought, a person, or an experience of humiliation or betrayal. It was described by Stanley Rachman and is notable because washing does not resolve it.'
  - q: 'How is contamination OCD treated?'
    a: 'With exposure and response prevention: graded contact with contaminants while not performing the washing, wiping, changing, or avoidance rituals. It is one of the presentations with the strongest and longest evidence base for ERP.'
related: [how-to-build-an-exposure-hierarchy, what-is-erp-exposure-response-prevention, checking-ocd]
---
...
This is the same mechanism as [checking OCD](/blog/checking-ocd), where repeated checking erodes memory confidence rather than building it.
...
Contamination is one of the easiest presentations to build a graded [hierarchy](/blog/how-to-build-an-exposure-hierarchy) for, because the dimensions of difficulty are so clear: what you touch, how long you wait, and what you touch next.
...
- [International OCD Foundation: Contamination fears](https://iocdf.org/about-ocd/)
