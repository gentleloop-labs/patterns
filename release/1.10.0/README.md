...
`dart run tool/check_arb_translator_context.dart`. Both checks fail while
unlocalized UI literals or English messages without translator context remain;
their reports are the working copy-freeze backlog.
