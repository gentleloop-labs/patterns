...
| RECOVERY-01 | Recovery Hub and ERP tools localization/accessibility | in progress | Recovery Hub, Compulsion Delay, and Guided ERP are code complete. Guided ERP now resolves all built-in titles, guidance, prompts, instructions, and cues from stable IDs in six languages without changing stored records. Remaining recovery tools remain |
