...
| RECOVERY-01 | Recovery Hub and ERP tools localization/accessibility | in progress | Recovery Hub and Compulsion Delay complete. Guided ERP completion and plan/editor shell now have six-locale copy, locale-aware dates/durations, semantic controls, large-text/reduced-motion coverage, save-before-confirmation, and safe failure handling. Built-in template content and remaining tools remain |
...
| AUDIT-01 | Zero reviewed mobile/shared user-facing literal candidates | in progress | Mobile-only scope excludes preserved desktop code; 284 candidates after the Guided ERP plan/editor shell slice |
...
- Full Flutter suite after the Guided ERP plan/editor shell: 250 passing tests.
- Mobile/shared literal audit: 284 candidates after the Guided ERP plan/editor shell slice. Preserved desktop code is outside the 1.10 gate.
