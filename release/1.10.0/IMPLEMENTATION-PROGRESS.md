...
| RECOVERY-01 | Recovery Hub and ERP tools localization/accessibility | in progress | Recovery Hub, Emergency Toolkit and breathing, Compulsion Delay, Guided ERP, Structured Programs, and the Y-BOCS self-check are code complete. Immediate-support copy no longer promises safety or urge disappearance and states the emergency-care boundary. Remaining recovery tools remain. |
...
| AUDIT-01 | Zero reviewed mobile/shared user-facing literal candidates | in progress | Mobile-only scope correctly excludes preserved desktop and legacy desktop-shell paths; 142 true mobile/shared candidates after completing Emergency Toolkit |
...
- Full Flutter suite after completing Emergency Toolkit: 263 passing tests.
- Mobile/shared literal audit: 142 candidates; stable localization selector keys are covered by narrow documented allowlist rules.
