...
| RECOVERY-01 | Recovery Hub and ERP tools localization/accessibility | in progress | Recovery Hub, Compulsion Delay, Guided ERP, Structured Programs, and the Y-BOCS self-check are code complete. Y-BOCS adds localized visible formatting, accessible controls and score alternatives, safe save/delete outcomes, and large-text coverage. Remaining recovery tools remain |
...
| AUDIT-01 | Zero reviewed mobile/shared user-facing literal candidates | in progress | Mobile-only scope correctly excludes preserved desktop and legacy desktop-shell paths; 154 true mobile/shared candidates after completing Y-BOCS |
...
- Full Flutter suite after completing Y-BOCS: 261 passing tests.
- Mobile/shared literal audit: 154 candidates; stable localization selector keys are covered by narrow documented allowlist rules.
