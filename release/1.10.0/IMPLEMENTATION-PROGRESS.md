...
| RECOVERY-01 | Recovery Hub and ERP tools localization/accessibility | in progress | Recovery Hub, Emergency Toolkit and breathing, Compulsion Delay, Guided ERP, Structured Programs, Y-BOCS, Exposure Hierarchy, Exposure Materials, Response Prevention, Urge Surfing, and Behavioral Experiments are code complete. Behavioral Experiments preserves user-authored predictions/actions/observations, keeps deliberately recorded confidence visible, uses factual text-and-icon states and locale-aware summaries, and leaves forms and lists retryable after CRUD failures. Remaining recovery tools remain. |
...
| AUDIT-01 | Zero reviewed mobile/shared user-facing literal candidates | in progress | Mobile-only scope correctly excludes preserved desktop and legacy desktop-shell paths; 87 true mobile/shared candidates after completing Behavioral Experiments |
...
- Full Flutter suite after completing Behavioral Experiments: 283 passing tests.
- Mobile/shared literal audit: 87 candidates; stable localization selector keys are covered by narrow documented allowlist rules.
