...
void main() {
  ...
  bool enough(List<DelaySession> delays) =>
  ...
  test(
    'three activities on the same day is still not enough (needs 2 days)',
    () {
      expect(enough([_delay(day1), _delay(day1), _delay(day1)]), isFalse);
    },
  );
  ...
  test('three activities across two+ distinct days reveals the score', () {
    expect(enough([_delay(day1), _delay(day2), _delay(day3)]), isTrue);
  });
}
