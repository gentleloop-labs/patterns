...
void main() {
  testWidgets('enabling app lock does not loop biometric prompts', (
    tester,
  ) async {
  ...
  testWidgets('cancelling the biometric prompt does not loop', (tester) async {
    SharedPreferences.setMockInitialValues({appLockPreferenceKey: true});
    await initMobilePreferences();
  ...
  testWidgets('lockout surfaces an explanation on the cover', (tester) async {
    SharedPreferences.setMockInitialValues({appLockPreferenceKey: true});
    await initMobilePreferences();
  ...
  testWidgets('missing biometric enrollment disables app lock', (tester) async {
    SharedPreferences.setMockInitialValues({appLockPreferenceKey: true});
    await initMobilePreferences();
  ...
  testWidgets('app-switcher peek (inactive) does not trigger auth', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues({appLockPreferenceKey: true});
    await initMobilePreferences();
  ...
  testWidgets('real backgrounding (paused → resumed) triggers re-auth', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues({appLockPreferenceKey: true});
    await initMobilePreferences();
